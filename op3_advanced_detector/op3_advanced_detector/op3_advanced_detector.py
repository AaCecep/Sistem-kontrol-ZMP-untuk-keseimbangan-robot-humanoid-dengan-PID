#!/home/robotis/yolo_env/bin/python3
...
class OP3AdvancedDetector(Node):
    ...
    def __init__(self):
        ...
        #self._init_performance_tracking() ZZZ
    ...
    def _init_ros_interfaces(self) -> None:
        ...
        #self._setup_image_subscriber() ZZZ
        ...
        self.debug_pub = (
            ...
            # if self.debug_mode else None ZZZ
        )

...
void SoccerDemo::setNode(rclcpp::Node::SharedPtr node)
{
  ...
  if (node_ != nullptr)
  {
    ...
    // ✅ Subscriber baru untuk game_controller
    game_state_sub_ = node_->create_subscription<std_msgs::msg::Int32>(
        "game_controller", 10,
        std::bind(&SoccerDemo::gameStateCallback, this, std::placeholders::_1));
...
void SoccerDemo::gameStateCallback(const std_msgs::msg::Int32::SharedPtr msg)
{
  last_game_state_ = msg->data;  // simpan nilai terakhir game_controller
}

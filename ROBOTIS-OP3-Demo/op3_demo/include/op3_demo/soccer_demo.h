...
class SoccerDemo : public OPDemo
{
 ...
 protected:
  ...
  // --- subscriber untuk game_controller ---
  rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr game_state_sub_;
  int last_game_state_;   // menyimpan nilai terakhir dari game_controller

  void gameStateCallback(const std_msgs::msg::Int32::SharedPtr msg);

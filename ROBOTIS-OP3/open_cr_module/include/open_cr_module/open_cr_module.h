...
// #include "open_cr_module/msg/orientation_rpy.h"
...
private:
  ...
  // rclcpp::Publisher<my_msg::msg::Orientation>::SharedPtr orientation_pub_; 
  rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr orientation_pub_;
